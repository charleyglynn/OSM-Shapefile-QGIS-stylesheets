...
<qgis version="2.2.0-Valmiera" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="fclass" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category symbol="2" value="suburb" label="suburb"/>
      <category symbol="3" value="town" label="town"/>
      <category symbol="4" value="village" label="village"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="0" type="marker" name="1">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
      ...
      <symbol alpha="0" type="marker" name="4">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/textColorB" value="91"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="capital"/>
    ...
    <edittype labelontop="0" editable="1" type="0" name="ele"/>
    ...
    <edittype labelontop="0" editable="1" type="0" name="poi"/>
