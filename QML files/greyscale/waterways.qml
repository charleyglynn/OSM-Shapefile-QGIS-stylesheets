...
<qgis version="2.6.1-Brighton" minimumScale="-4.65661e-10" maximumScale="1e+06" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="osm_id">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="timestamp">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{8f0c2daf-c297-4d72-a8c5-5fafbb92e753}">
      <rule filter="type IN ('river', 'stream', 'canal')" key="{93c1a9b7-ddda-4661-944c-854d94218eda}" symbol="0" label="main river"/>
      <rule filter="type NOT IN ('river', 'stream', 'canal')" key="{e8f6df0b-eed3-4689-afd7-665c9b5331a7}" symbol="1" label="small river"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="212,212,212,255"/>
