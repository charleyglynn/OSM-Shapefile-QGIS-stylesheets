...
<qgis version="2.6.1-Brighton" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="type" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category render="true" symbol="3" value="town" label="town"/>
      <category render="true" symbol="4" value="village" label="village"/>
    </categories>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/textColorB" value="105"/>
    <property key="labeling/textColorG" value="105"/>
