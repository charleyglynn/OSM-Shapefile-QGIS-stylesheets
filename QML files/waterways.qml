...
<qgis version="2.2.0-Valmiera" minimumScale="0" maximumScale="1e+06" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter="type IN ('river', 'stream', 'canal')" symbol="0" label="main river"/>
      <rule filter="type NOT IN ('river', 'stream', 'canal')" symbol="1" label="small river"/>
    </rules>
    <symbols>
